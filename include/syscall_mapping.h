...
** syscall mapping
** File description:
** list of syscall and mapping type/fct
*/

#ifndef SYSCALL_MAPPING_H_
#define SYSCALL_MAPPING_H_

#include <stdlib.h>
#include "strace.h"

static const t_arg_type arg_type[] =
{
    {"void", &do_nothing},
    {"char *", &print_string},
    {"char **", &print_tab},
    {"int", &print_int},
    {"int[2]", &print_pointer},
    {"uint32_t", &print_un_int},
    {"unsigned int", &print_un_int},
    {"long", &print_long},
    {"unsigned long", &print_un_long},
    {"u64", &print_un_long},
    {"size_t", &print_un_long},
    {"ssize_t", &print_long},
    ...
    {"dev_t", &print_un_long},
    {"off64_t", &print_un_long},
    {"cpu_set_t", &print_un_long},
    {"aio_context_t", &print_un_long},
    {"mqd_t", &print_int},
    {"idtype_t", &print_un_long},
    {"off_t", &print_un_long},
    {"key_t", &print_un_long},
    {"pid_t", &print_int},
    {"socklen_t", &print_un_long},
    {"uid_t", &print_int},
    {"gid_t", &print_int},
    {"gid_t[]", &print_pointer},
    {"clock_t", &print_un_long},
    {"key_serial_t", &print_un_long},
    {"unimplemented", &print_not_implemented},
    {"default", &print_pointer},
    {NULL, NULL}
};

static const t_syscall_params sys_proto[] =
{
    ...
    {"sendto", 6,
    {"int", "void *", "size_t", "int", "struct sockaddr *", "socklen_t"}, "ssize_t"},
    {"recvfrom", 6,
    ...
    {"process_vm_writev", 6,
    {"pid_t", "struct iovec *", "unsigned long", "struct iovec *", "unsigned long", "unsigned long"}, "ssize_t"},
    {"kcmp", 5,
